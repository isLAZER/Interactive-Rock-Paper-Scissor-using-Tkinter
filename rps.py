...
#Images
qmark = ImageTk.PhotoImage(Image.open(fr"resources\que_mark.png"))       #Question Mark Image
you_img = ImageTk.PhotoImage(Image.open(fr"resources\you.png"))          #You Word Image
comp_img = ImageTk.PhotoImage(Image.open(fr"resources\computer.png"))    #Computer Word Image
title = ImageTk.PhotoImage(Image.open(fr"resources\rps_title.png"))      #Title Image
rock_ = ImageTk.PhotoImage(Image.open(fr"resources\rock.png"))           #Rock Hand Sign
paper_ = ImageTk.PhotoImage(Image.open(fr"resources\paper.png"))         #Paper Hand Sign
scissor_ = ImageTk.PhotoImage(Image.open(fr"resources\scissor.png"))     #Scissor Hand Sign
...
#Buttons
rock = tk.Button(root, text = 'Rock', font = ("consolas", 10, "bold"), command = r, width = 8, height = 2, bg = "#ffe69a", fg = "blue", borderwidth = 0.1)
paper = tk.Button(root, text = 'Paper', font = ("consolas", 10, "bold"), command = p, width = 8, height = 2, bg = "#ffe69a", fg = "blue", borderwidth = 0.1)
scissor = tk.Button(root, text = 'Scissor', font = ("consolas", 10, "bold"), command = s, width = 8, height = 2, bg = "#ffe69a", fg = "blue", borderwidth = 0.1)
diff = tk.Button(root, text = 'Easy', font = ("consolas", 10, "bold"), command = difficulty, width = 12, height = 2, bg = "#ffe69a", fg = "blue", borderwidth = 0.1)
